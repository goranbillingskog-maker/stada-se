...
const POLL_TIMEOUT_MS = 200_000; // ~3,3 min per BrowserAct-anrop - vi kor anropen parallellt nar mojligt
...
async function waitForTask(taskId) {
  ...
  throw new Error("BrowserAct-uppgiften tog för lång tid (mer än 3 minuter). Försök igen.");
}
