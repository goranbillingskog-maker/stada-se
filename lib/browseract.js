...
const POLL_TIMEOUT_MS = 130_000; // ~2 min per BrowserAct-anrop - vi gör upp till tva sekventiella anrop inom Vercels 5-minutersgrans
...
async function waitForTask(taskId) {
  ...
  throw new Error("BrowserAct-uppgiften tog för lång tid (mer än 2 minuter). Försök igen.");
}
